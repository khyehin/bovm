<?php
// public/user/company1/customer_add.php
...
// mirror admin/customers/edit.php in a simplified way, fixed category_id = 3
$errors = [];
$data = [
  'code'                 => '',
  'name'                 => '',
  ...
  if (!$errors) {
    try {
      $sql = "INSERT INTO customers
                (category_id, code, name, reg_no, billing_name,
              ...
              VALUES
                (3, :code, :name, :reg_no, :billing_name,
                 :contact_name, :contact_phone, :contact_email,
                 :default_receipt_name, :default_receipt_nric,
                 :address1, :address2, :address3,
                 :city, :state, :postcode, :country,
    ...
    <div class="admin-card admin-card-elevated admin-card-narrow">
      <div class="form-page-header" style="margin-bottom:14px;">
        <div>
          ...
          <h2 class="form-page-title">Add new customer</h2>
          <div class="form-page-subtitle">New customers created here will be fixed to Category 3.</div>
        </div>
